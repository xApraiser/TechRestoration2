...
<form class="row g-3 needs-validation" method="POST" action="gestionarcliente.html">
  ...
  <tbody>
    ...
    <tr>
      <th scope="row">2</th>
      <td>Maria</td>
      <td>mariacanales.1@gmail.com</td>
      <td>977777777</td>
      <td>Encargado 2</td>
      <td><input type="submit" value="✎"></td>
    </tr>
