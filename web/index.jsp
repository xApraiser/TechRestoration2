...
%>
    ...
    <body>
        ...
        <div class="centrartitulos">
            <center><h1 class="letrastitulos">Gestión de clientes - Tech-restoration</h1></center>
        ...
        <form>
            ...
            <div class="container-index">
                ...
                <div class="form-group">
                    ...
                    <br>
                    <center>  <input type="submit" value="Iniciar Sesión" class="btn btn-success" id="btnIniciarSesion"></center>
